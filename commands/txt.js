...
cmd({ pattern: "slice", category: "logo", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
        if (!text) return citel.reply('*_Example : .slice Troublemaker Bot_*');
...
cmd({ pattern: "glow", category: "logo", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
        if (!text) return citel.reply('*_Example : .glow Troublemaker Bot_*');
        return await singleText(Void, citel , 'free-advanced-glow-text-effect-873' , text )
    })
//----------------------------------------------------------------------------------- 
cmd({ pattern: "gitch2", category: "logo", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
        if (!text) return citel.reply('*_Example : .gitch2 Troublemaker Bot_*');
        return await singleText(Void, citel , 'create-impressive-glitch-text-effects-online-1027' , text )        
    }) 
//---------------------------------------------------------------------------
//================================================================================================================================
cmd({ pattern: "steel3d",category: "logo", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
            if (!text) return citel.reply('_Example : .steel3d Trouble;Maker_');  
...
cmd({ pattern: "avenger",category: "logo", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
            if (!text) return citel.reply('*_Example : .avenger Trouble;Maker_*');  
            let text1 = text ? text.split(';')[0] : '';
            let text2 = text ? text.split(';')[1] : '';
...
cmd({ pattern: "marvel",category: "logo", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
            if (!text) return citel.reply('*_Example : .marvel Trouble;Maker_*');  
            let text1 = text ? text.split(';')[0] : '';
            let text2 = text ? text.split(';')[1] : '';
...
cmd({ pattern: "phub",category: "logo", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
            if (!text) return citel.reply('*_Example : .phub Trouble;Maker_*');  
            let text1 = text ? text.split(';')[0] : '';
            let text2 = text ? text.split(';')[1] : '';
...
cmd({ pattern: "glitch",category: "logo", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
            if (!text) return citel.reply('*_Example : .Trouble;Maker_*');  
            let text1 = text ? text.split(';')[0] : '';
            let text2 = text ? text.split(';')[1] : '';
...
cmd({ pattern: "glitch1",category: "logo", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
            if (!text) return citel.reply('*_Example : .glitch1 Trouble;Maker_*');  
            let text1 = text ? text.split(';')[0] : '';
            let text2 = text ? text.split(';')[1] : '';
...
cmd({ pattern: "grafiti",category: "logo", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
            if (!text) return citel.reply('*_Example : .grafiti Trouble;Maker_*');  
            let text1 = text ? text.split(';')[0] : '';
            let text2 = text ? text.split(';')[1] : '';
...
//---------------------------------------------------------------------------
cmd({ pattern: "sunset", category: "logo", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
        if (!text) return citel.reply('_Need text._')
        return await singleText(Void, citel , 'create-sunset-logo-style-online-1124' , text )
    })
